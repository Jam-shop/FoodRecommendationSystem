...
-> The users table has attribute profile_pic with data type BLOB, which for simplicity and feasibility purposes we assumed to be varchar while making the video.

-> Since we are using terminal, it wasnt feasible and easy to imply attributes NULL's values. Hence, for video we assumed every value to be NOT NULL (by populating in the database those attrbutes by giving them some values).


Video drive link: https://iiitaphyd-my.sharepoint.com/:f:/g/personal/saloni_goyal_research_iiit_ac_in/EoSmECkFseZDmKLX5rvtjioBkMh7KavvtDSNioesCky1ug?e=iCO2uI
...
3. IF userPurpose="Restaurant_Owner"
